# Banking-Java-AppDatabase Person (Franklin) → Owns the data layer, ensures persistence, and connects everyone’s work. This is essential because the database is the backbone of the banking app.
